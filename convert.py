...
COMMIT_DESCRIPTION = """
🚀 This is an automated PR created with 🌟 PyTorch Model to SafeTensors Converter
🔒 This new file is equivalent to `pytorch_model.bin` but safer in the sense that
...
if __name__ == "__main__":
    DESCRIPTION = """
    🛠️ Simple utility tool designed to automatically convert weights on the hub to the `safetensors` format.
    🔒 Currently exclusive to PyTorch models.
    📥 Process involves downloading the weights (PT), performing local conversion, and uploading them back as a PR on the hub.
    """
    ...
    if args.y:
        ...
        txt = input(
            ...
            " https://colab.research.google.com/drive/1SPeEuBWFTWKt3OnwY2uFWnkUUJZlLhQE#scrollTo=yHJ8ePH1oR5k to avoid potential issues with this file."
            " Continue [Y/n] ?"
        )
    if txt.lower() in {"", "y"}:
        ...
        string = f"""
🎉 **Success!** 🔥
Yay! This model has been successfully converted, and a PR has been created using your token. Check it out here:
